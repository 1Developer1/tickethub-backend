...
export const createEventSchema = z.object({
  ...
  (data) => new Date(data.salesEndAt) <= new Date(data.startsAt),
  { message: 'Sales must end before event starts', path: ['salesEndAt'] },
);
...
export const updateEventSchema = z.object({
  ...
  category: z.enum(['CONCERT', 'THEATER', 'SPORTS', 'FESTIVAL', 'COMEDY', 'CONFERENCE', 'OTHER']).optional(),
